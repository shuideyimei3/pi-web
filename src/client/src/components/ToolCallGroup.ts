...
export class ToolCallGroup extends LitElement {
  ...
  static override styles = [quantumBeaconStyles, css`
    ...
    .tool-group { display: grid; gap: 6px; width: 100%; max-width: 100%; min-width: 0; }
    ...
    .group-body { display: grid; gap: 6px; padding-left: 8px; }
    ...
    .preview-chip.success { border-color: rgba(127,209,160,.2); }
    .preview-chip.error { border-color: rgba(248,123,123,.25); }
    .preview-chip.running, .preview-chip.pending { border-color: rgba(139,178,255,.25); }
